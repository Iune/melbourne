...
from PySide6.QtCore import QPoint, QPoint
...
class Scoreboard:
    ...
    def generate(self, voter: int) -> str:
        ...
        sizes = ScoreboardSizes(self.details, self.fonts, voter)
        image = QImage(ceil(sizes.width), ceil(sizes.height), QImage.Format_ARGB32)
